...
function fixString(str) -- Turns a space seperated string into a comma seperated string
	local outStr = ""
...
function getPronoun(unit) -- Returns, He/His, She/Her, It/Its
	local str1 = "It"
	local str2 = "Its"
	if unit.sex == 0 then
		str1 = "She"
...
function get_hf_name(id,translate) -- Returns the units name
...
--  < -40  |  -25  |  -10  |  10  |  25  |  40  >
-- -3     -2      -1       0      1      2      3
-- string = values[unit.status.current_soul.personality.values[#].type][bin]
...
function value_string(value)
	...
	return values[value.type][bin], bin
end
